...
class Socket extends require("socket.io").Server {

  constructor(server = {}, serverOptions = require('./src/options')(),...arrayOfObjects) {
  ...
  path (path = '', Socket = './app/controllers/http') {
    return require('path').join(Socket, path)
  }
